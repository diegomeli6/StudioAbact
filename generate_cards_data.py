# Script per generare data/progetto-cards-data.js con quiz e spiegazioni sul codice HTML e CSS di Progetto_Esame_Cards
import json
...
output_file = 'data/progetto-cards-data.js'
with open(output_file, 'w', encoding='utf-8') as f:
    f.write(f"// Dati di studio e quiz approfonditi sul codice di 'Progetto_Esame_Cards' (HTML & CSS)\nwindow.CARDS_DATA = {json.dumps(project_modules, indent=2, ensure_ascii=False)};\n")

print(f"data/progetto-cards-data.js generato con {len(project_modules)} moduli sul codice.")
