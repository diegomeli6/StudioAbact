# Script per generare data/krug-data.js dettagliato e approfondito
import json
...
content = f"// Dati di studio approfonditi estratti da 'Riassunto_Dont_Make_Me_Think_Krug.pdf'\nwindow.KRUG_DATA = {json.dumps(krug_chapters, indent=2, ensure_ascii=False)};\n"
with open('data/krug-data.js', 'w', encoding='utf-8') as f:
    f.write(content)

print(f"data/krug-data.js generato con successo. Moduli: {len(krug_chapters)}")
