...
with open('data/progetto-cards-data.js', 'w', encoding='utf-8') as f:
    f.write("// Dati di studio approfonditi sul codice del Progetto Esame Cards\n")
    f.write("window.CARDS_DATA = " + json.dumps(modules, indent=2, ensure_ascii=False) + ";\n")

print(f"data/progetto-cards-data.js generato con {len(modules)} capitoli e {sum(len(m['quiz']) for m in modules)} quiz totali!")
