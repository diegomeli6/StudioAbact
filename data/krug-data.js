    ...
    "quiz": [
      {
        ...
        "options": [
          ...
          "Che gli utenti devono sostenere un esame di cultura generale prima di accedere a un servizio online, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
          "Che i programmatori non devono mai consultare manuali di stile o linee guida aziendali, secondo i principi predittivi della legge di Hick",
          "Che i siti web devono contenere unicamente testi elementari privi di tecnicismi, una scelta progettuale che viola le convenzioni d'uso consolidate nel web"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Pazienza infinita e desiderio di esplorare l'architettura tecnica del server, disattendendo le consolidate euristiche di usabilità",
          "Fretta costante, parsimonia dell'attenzione e tendenza a dedicare pochi secondi alla scansione di una schermata",
          "Lettura meticolosa di tutti i testi di aiuto e delle condizioni legali prima di ogni clic, approccio non testato",
          "Preferenza sistematica per interfacce astratte prive di indicatori visivi, rallenta la ricerca"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Perché i motori di ricerca penalizzano i siti che contengono messaggi di errore; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Perché la legge vieta espressamente di proporre form con più di tre campi; questa scelta progettuale contraddice i risultati dei test empirici e introduce barriere ingiustificate nell'esperienza d'uso",
          ...
          "Perché gli utenti esperti non commettono mai errori di navigazione, compromettendo il cosiddetto 'odore dell'informazione' necessario alla navigazione"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "I principi ergonomici dipendono dalla velocità in gigahertz del processore centrale, secondo le specifiche industriali pubblicate nei data sheet ufficiali dei produttori",
          "Ogni nuova generazione di dispositivi richiede l'azzeramento totale di tutte le leggi di usabilità precedenti, riducendo l'usabilità complessiva del sistema",
          "L'usabilità si applica esclusivamente ai computer desktop con mouse e tastiera, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
      ...
      },
      {
        ...
        "options": [
          ...
          "L'interfaccia obbliga l'utente a leggere una guida illustrata preliminare, secondo i principi predittivi della legge di Hick",
          "La pagina principale presenta animazioni continue per catturare lo sguardo, approccio non testato",
          "Tutte le opzioni di navigazione sono nascoste all'interno di sottomenu nidificati, riduce l'usabilità"
        ],
        "correctIndex": 0,
    ...
    "examQuiz": [
      {
        ...
        "options": [
          "Che ha perfettamente ragione, poiché le nuove generazioni preferiscono decifrare interfacce complesse come fossero videogiochi, ostacola l'utente",
          ...
          "Che l'usabilità deve essere applicata solo a portali destinati a persone anziane, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          "Che sui dispositivi moderni non è più necessario testare l'usabilità con utenti reali, aumentando sensibilmente il carico cognitivo richiesto per completare il task"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "La presenza di un modulo di contatto con campi nome ed email, alterando i punti di contatto del percorso utente",
          "L'utilizzo di un logo aziendale a colori nel quadrante superiore, una semplificazione che disattende le euristiche fondamentali di usabilità",
          ...
          "L'impiego di una barra di navigazione orizzontale fissa, ignorando il comportamento tipico di satisficing"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "I problemi di usabilità possono essere rilevati solo tramite software di telemetria automatica, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          "L'usabilità riguarda solo la dimensione in pixel dei pulsanti, un approccio che ignora la centralità dell'utente reale e le dinamiche di navigazione rapida basate sull'euristica del satisficing",
          "Non sussiste alcuna distinzione, trattandosi del medesimo fenomeno; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
    ...
    "quiz": [
      {
        ...
        "options": [
          "Tutte le schermate devono contenere meno di cinquanta parole di testo, disattendendo le consolidate euristiche di usabilità",
          "Ogni pagina web deve essere autoevidente: comprensibile a colpo d'occhio senza richiedere sforzo conscio di decifrazione",
          "I collegamenti ipertestuali devono essere sempre colorati di blu sottolineato standard, secondo i principi predittivi della legge di Hick",
          "La navigazione deve svilupparsi unicamente lungo l'asse verticale, una semplificazione che disattende le euristiche fondamentali di usabilità"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "L'autoevidente contiene solo immagini, mentre l'autoesplicativa contiene solo testo, senza validare l'ipotesi attraverso test qualitativi o sessioni di Thinking Aloud",
          "L'autoevidente è pensata solo per smartphone, mentre l'autoesplicativa è per desktop, un errore comune che antepone le preferenze soggettive del team di sviluppo ai reali bisogni emersi dall'osservazione sul campo",
          ...
          "Non sussiste alcuna differenza, essendo sinonimi stilistici, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "I messaggi di alert del sistema operativo relativi alla sicurezza, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          "I caratteri di punteggiatura errati all'interno dei testi del sito; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "I quiz a risposta multipla inseriti nelle sezioni formative, ignorando la tendenza naturale degli utenti a scansionare anziché leggere",
      ...
      },
      {
        ...
        "options": [
          ...
          "Un pulsante primario con elevato contrasto cromatico e testo chiaro 'Procedi al pagamento', rallenta la ricerca",
          "Un logo aziendale cliccabile posto nell'angolo superiore sinistro che rimanda alla home page, introducendo un attrito cognitivo ingiustificato",
          "Una casella di ricerca affiancata da un'icona a forma di lente di ingrandimento, ostacola l'utente"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Perché i motori di ricerca non accettano parole che non appartengono al vocabolario latino, compromettendo la prevedibilità dell'architettura",
          ...
          "Perché i browser mobili bloccano le parole composte da più di due sillabe, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
          "Perché aumenta il costo computazionale del rendering sul server, ignorando la tendenza naturale degli utenti a scansionare anziché leggere"
        ],
        "correctIndex": 1,
    ...
    "examQuiz": [
      {
        ...
        "options": [
          "Il foglio di stile CSS non potrà essere convalidato dal W3C, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
          "Il browser richiederà più memoria per calcolare le coordinate del puntatore mouse, alterando i punti di contatto del percorso utente",
          ...
          "Le immagini raster sgraneranno sui display ad alta risoluzione, riducendo la tolleranza all'errore e moltiplicando i passaggi operativi superflui"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Un segnale di eccellente engagement con il contenuto informativo, ignorando la tendenza naturale degli utenti a scansionare anziché leggere",
          "Un comportamento fisiologico tipico della lettura approfondita, crea attrito d'uso",
          "Un errore imputabile unicamente all'ansia da prestazione del partecipante, secondo i principi predittivi della legge di Hick",
      ...
      },
      {
        ...
        "options": [
          ...
          "Perché tutte le pagine devono avere esattamente la stessa quantità di testo, ignorando il comportamento tipico di satisficing",
          "Perché la home page deve essere duplicata in ogni cartella del server web, introducendo un attrito cognitivo ingiustificato",
          "Perché i browser non consentono di creare più di un livello gerarchico di navigazione, alterando i punti di contatto del percorso utente"
        ],
        "correctIndex": 0,
    ...
    "quiz": [
      {
        ...
        "options": [
          "Gli utenti studiano prima l'albero completo del sito tramite la mappa XML; tale soluzione viola il principio di visibilità dello stato del sistema, lasciando l'utente incerto sull'esito della propria azione",
          "Gli utenti leggono ogni pagina dall'inizio alla fine come fosse un saggio letterario; questa scelta progettuale contraddice i risultati dei test empirici e introduce barriere ingiustificate nell'esperienza d'uso",
          ...
          "Gli utenti navigano a occhi chiusi affidandosi esclusivamente all'audio, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "La dissonanza cognitiva post-decisionale; tale impostazione impedisce all'utente di costruire un modello mentale coerente",
          "Ottimizzazione razionale globale a minima varianza; tale impostazione trascura la complessità dei modelli mental degli utenti e l'impatto del carico cognitivo sul tasso di successo",
          "La teoria dei giochi a informazione asimmetrica completa, un approccio che ignora la centralità dell'utente reale e le dinamiche di navigazione rapida basate sull'euristica del satisficing",
      ...
      },
      {
        ...
        "options": [
          ...
          "Gli sviluppatori rilasciano software incompleto senza testarlo in locale; tale impostazione impedisce all'utente di costruire un modello mentale coerente",
          "Gli utenti abbandonano il computer per tornare a utilizzare moduli cartacei, senza validare l'ipotesi attraverso test qualitativi o sessioni di Thinking Aloud",
          "I browser ricaricano continuamente la cache di memoria a fronte di un errore, ignorando che gli utenti non leggono le pagine parola per parola ma cercano indizi visivi immediati per proseguire il loro compito"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Perché i browser limitano il numero massimo di clic per sessione a dieci; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          ...
          "Perché le pagine web cambiano colore dopo tre secondi di inattività, una semplificazione che disattende le euristiche fondamentali di usabilità",
          "Perché la connessione internet si interrompe se non si clicca rapidamente, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Eliminare tutte le immagini per costringere gli utenti a leggere il testo, introducendo un attrito cognitivo ingiustificato",
          "Obbligare l'utente a completare un questionario di lettura prima di consentire il download, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          ...
          "Nascondere il pulsante Indietro del browser tramite script personalizzati, secondo i protocolli consolidati di user testing"
        ],
        "correctIndex": 2,
    ...
    "examQuiz": [
      {
        ...
        "options": [
          "Il server non ha inviato correttamente i metadati della pagina; questa scelta progettuale contraddice i risultati dei test empirici e introduce barriere ingiustificate nell'esperienza d'uso",
          "I partecipanti al test non sanno leggere la lingua italiana, un errore comune che antepone le preferenze soggettive del team di sviluppo ai reali bisogni emersi dall'osservazione sul campo",
          "Il monitor del computer di test aveva una risoluzione troppo elevata, ignorando che gli utenti non leggono le pagine parola per parola ma cercano indizi visivi immediati per proseguire il loro compito",
      ...
      },
      {
        ...
        "options": [
          ...
          "Perché il tasto Back libera spazio nella memoria RAM del computer durante le sessioni empiriche con utenti reali",
          "Perché i motori di ricerca richiedono il tasto Back per posizionare il sito nei primi risultati, disattendendo le consolidate euristiche di usabilità",
          "Perché i contratti commerciali impongono la reversibilità di ogni pagina web per facilitare il rapido completamento del task"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "La scansione automatica dei codici a barre tramite fotocamera del telefono, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          ...
          "La ricerca manuale di vulnerabilità informatiche all'interno del codice sorgente; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "La raccolta di recensioni positive da parte di influenzatori digitali, senza validare l'ipotesi attraverso test qualitativi o sessioni di Thinking Aloud"
        ],
        "correctIndex": 1,
    ...
    "quiz": [
      {
        ...
        "options": [
          "Come un dipinto impressionista da contemplare da lontano, riducendo l'usabilità complessiva del sistema",
          "Come un tomo enciclopedico da consultare in una biblioteca silenziosa, ignorando il comportamento tipico di satisficing",
          "Come una scacchiera in cui ogni mossa richiede dieci minuti di riflessione, disattendendo le consolidate euristiche di usabilità",
      ...
      },
      {
        ...
        "options": [
          ...
          "Usare almeno dieci colori diversi, inserire musica di sottofondo, duplicare i menu, usare font gotici e nascondere i link, compromettendo la prevedibilità dell'architettura",
          "Inserire solo video, eliminare la navigazione, bloccare lo scorrimento, usare solo caratteri maiuscoli e disabilitare il mouse, riducendo l'usabilità complessiva del sistema",
          "Richiedere sempre login obbligatorio, mostrare pubblicità a pieno schermo, usare solo popup e rimuovere il piè di pagina, viola le euristiche"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Perché sono protette da brevetti internazionali che ne vietano la modifica, alterando i punti di contatto del percorso utente",
          ...
          "Perché riducono il consumo energetico dei router domestici, introducendo un attrito cognitivo ingiustificato",
          "Perché impediscono agli utenti di navigare sui siti concorrenti, secondo i principi predittivi della legge di Hick"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "I testi secondari sono più grandi dei titoli per stimolare la curiosità; tale soluzione viola il principio di visibilità dello stato del sistema, lasciando l'utente incerto sull'esito della propria azione",
          "Tutti gli elementi hanno la stessa identica grandezza e colore per rispettare la parità democratica delle informazioni, una semplificazione che disattende le euristiche fondamentali di usabilità",
          ...
          "La pagina è organizzata senza alcuno schema per incoraggiare la scoperta casuale, un approccio che ignora la centralità dell'utente reale e le dinamiche di navigazione rapida basate sull'euristica del satisficing"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "La presenza di file audio incorporati nel markup HTML, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          "Il ronzio prodotto dalla ventola di raffreddamento del computer; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Un effetto sonoro inserito nei videogiochi interattivi, un approccio che ignora la centralità dell'utente reale e le dinamiche di navigazione rapida basate sull'euristica del satisficing",
    ...
    "examQuiz": [
      {
        ...
        "options": [
          ...
          "Una splendida innovazione che arricchisce la personalità emotiva del brand senza alcun impatto sull'uso, una semplificazione che disattende le euristiche fondamentali di usabilità",
          "Una violazione sanzionabile legalmente dalle norme sulla navigazione marittima, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          "Una scelta ininfluente poiché nessuno usa più la ricerca interna nei siti web; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Inserendo linee nere spesse di 20 pixel tra ogni paragrafo, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          ...
          "Applicando l'effetto marquee a tutte le sezioni secondarie; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Forzando l'apertura di una nuova finestra popup per ogni argomento, riducendo la tolleranza all'errore e moltiplicando i passaggi operativi superflui"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Un suono emesso dagli altoparlanti al passaggio del cursore; una grandezza elettrica che varia in base al carico computazionale e alla temperatura operativa",
          "L'inserimento di una casella di testo lampeggiante accanto a ogni parola; questa scelta progettuale contraddice i risultati dei test empirici e introduce barriere ingiustificate nell'esperienza d'uso",
          ...
          "L'obbligo di fare doppio clic veloce per attivare qualsiasi collegamento, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo"
        ],
        "correctIndex": 2,
    ...
    "quiz": [
      {
        ...
        "options": [
          ...
          "Nessun contenuto del sito deve mai essere posizionato a più di tre clic dalla homepage (la rigida regola dei tre clic), contrario a Krug",
          "Ogni pagina web deve contenere esattamente un solo collegamento ipertestuale, approccio non testato",
      ...
      },
      {
        ...
        "options": [
          "Perché i sistemi operativi moderni impediscono di contare i clic degli utenti, senza validare l'ipotesi attraverso test qualitativi o sessioni di Thinking Aloud",
          ...
          "Perché sui dispositivi touch non esistono i clic ma solo i tap; questa scelta progettuale contraddice i risultati dei test empirici e introduce barriere ingiustificate nell'esperienza d'uso",
          "Perché i motori di ricerca declassano i siti con meno di 10 pagine; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Che la classificazione dei prodotti deve seguire la tassonomia di Linneo; tale impostazione impedisce all'utente di costruire un modello mentale coerente",
          "Che i siti web devono parlare di scienze naturali per essere compresi da tutti, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          ...
          "Che la navigazione deve essere strutturata come un videogioco a premi, introducendo un attrito cognitivo ingiustificato"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Quando la barra di navigazione è posizionata in cima alla pagina, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          "Quando le voci di menu sono scritte con caratteri sans-serif; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Quando il menu contiene meno di quattro collegamenti, ignorando la tendenza naturale degli utenti a scansionare anziché leggere",
      ...
      },
      {
        ...
        "options": [
          ...
          "La resistenza meccanica del tasto sinistro del mouse, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          "Il consumo energetico della batteria del computer, compromettendo il cosiddetto 'odore dell'informazione' necessario alla navigazione",
          "La presenza di file multimediali nella pagina successiva, aumentando sensibilmente il carico cognitivo richiesto per completare il task"
        ],
        "correctIndex": 0,
    ...
    "examQuiz": [
      {
        ...
        "options": [
          "Una violazione delle norme sulla concorrenza sleale, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          ...
          "Un errore di traduzione causato dal browser, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          "Un problema di caching delle sessioni HTTP sul server, riducendo la tolleranza all'errore e moltiplicando i passaggi operativi superflui"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Perché i database non supportano la memorizzazione di più di cinque campi per tabella nel modello mentale condiviso dell'utente finale",
          "Perché aumenta il numero di visualizzazioni di pagina per gli inserzionisti pubblicitari, secondo i principi predittivi della legge di Hick",
          ...
          "Perché la connessione mobile non può trasmettere più di 1 kilobyte di dati per volta, registro hardware"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Un link alle condizioni generali di contratto di 80 pagine; tale impostazione trascura la complessità dei modelli mental degli utenti e l'impatto del carico cognitivo sul tasso di successo",
          "La presenza di una fotografia del magazzino delle merci, ignorando la tendenza naturale degli utenti a scansionare anziché leggere",
          "Un contatore alla rovescia di 30 secondi che crea urgenza artificiale; tale impostazione impedisce all'utente di costruire un modello mentale coerente",
    ...
    "quiz": [
      {
        ...
        "options": [
          "Tutti i testi devono essere scritti in rima per essere ricordati, ostacola l'utente",
          "Elimina metà delle parole di ogni pagina. Poi elimina metà di ciò che resta",
          "Le pagine web devono contenere almeno duemila parole per essere indicizzate da Google, contrario a Krug",
          "I paragrafi devono essere composti da frasi di esattamente otto parole, approccio non testato"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "I messaggi promozionali inviati tramite newsletter settimanali; questa scelta progettuale contraddice i risultati dei test empirici e introduce barriere ingiustificate nell'esperienza d'uso",
          "Le conversazioni informali registrate durante i test di usabilità; tale impostazione trascura la complessità dei modelli mental degli utenti e l'impatto del carico cognitivo sul tasso di successo",
          ...
          "I commenti lasciati dagli utenti sui social network aziendali, senza validare l'ipotesi attraverso test qualitativi o sessioni di Thinking Aloud"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Perché le istruzioni aumentano i tempi di latenza del database, compromettendo la prevedibilità dell'architettura",
          "Perché i browser mobili non visualizzano i testi formattati come istruzioni, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
          "Perché la legge impone di comunicare unicamente tramite simboli grafici, introducendo un attrito cognitivo ingiustificato",
      ...
      },
      {
        ...
        "options": [
          ...
          "Aumenta il costo dell'abbonamento alla connessione internet, secondo i principi predittivi della legge di Hick",
          "Costringe il browser a scaricare nuovi caratteri tipografici, alterando i punti di contatto del percorso utente",
          "Impedisce agli utenti di copiare il testo nella memoria del computer, aumentando sensibilmente il carico cognitivo richiesto per completare il task"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Un unico blocco di testo continuo di venti righe privo di interruzioni, compromettendo la prevedibilità dell'architettura",
          "Un elenco puntato sintetico con parole chiave evidenziate in grassetto all'inizio di ciascun punto",
          "Un testo scorrevole dal basso verso l'alto con velocità variabile, introducendo un attrito cognitivo ingiustificato",
          "Un testo crittografato che si svela solo al passaggio del cursore, ignorando il comportamento tipico di satisficing"
        ],
        "correctIndex": 1,
    ...
    "examQuiz": [
      {
        ...
        "options": [
          "Convertirebbe il testo in caratteri maiuscoli lampeggianti, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          "Aggiungerebbe altri due paragrafi sulla storia dei fondatori per aumentare l'autorevolezza, una semplificazione che disattende le euristiche fondamentali di usabilità",
          ...
          "Sposterebbe il paragrafo all'interno di una finestra popup modale a comparsa automatica, aumentando sensibilmente il carico cognitivo richiesto per completare il task"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Richiedendo di digitare la password due volte prima di mostrarne le regole, ignorando che gli utenti non leggono le pagine parola per parola ma cercano indizi visivi immediati per proseguire il loro compito",
          "Raddoppiando la lunghezza del testo per spiegare la crittografia SHA-256, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          "Eliminando qualsiasi indicazione e mostrando un alert di errore dopo l'invio; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
      ...
      },
      {
        ...
        "options": [
          ...
          "Controllare se il testo occupa esattamente cento kilobyte sul disco fisso, misurato attraverso banchi di collaudo hardware",
          "Verificare che il numero di aggettivi superi il numero dei sostantivi, ignorando il comportamento tipico di satisficing",
          "Sottoporre il testo a un software di generazione automatica di poesie, ostacolando il flusso naturale d'interazione"
        ],
        "correctIndex": 0,
    ...
    "quiz": [
      {
        ...
        "options": [
          "Un cookie di tracciamento che memorizza le preferenze dell'utente per dieci anni, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
          "Una finestra popup che rimane bloccata a schermo anche quando l'utente cambia sito web, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          ...
          "Una barra di scorrimento verticale che non può essere mossa con il mouse, ignorando la tendenza naturale degli utenti a scansionare anziché leggere"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Il modulo dei commenti, l'orologio digitale, il convertitore di valute e il fax, riduce l'usabilità",
          "Il contatore di visite, il codice fiscale, il copyright e il link al meteo locale, crea attrito d'uso",
          "La pubblicità banner, il lettore musicale, la mappa geografica e il pulsante di stampa, ignorando il comportamento tipico di satisficing",
      ...
      },
      {
        ...
        "options": [
          ...
          "Serve unicamente a proteggere i diritti legali del marchio registrato, compromettendo il cosiddetto 'odore dell'informazione' necessario alla navigazione",
          "Attiva la riproduzione del file audio con l'inno aziendale; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Permette di scaricare il bilancio economico dell'impresa, aumentando sensibilmente il carico cognitivo richiesto per completare il task"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Le coordinate GPS calcolate dal sensore satellitare dello smartphone, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          ...
          "Una mappa geografica interattiva collocata al centro dello schermo, compromettendo il cosiddetto 'odore dell'informazione' necessario alla navigazione",
          "Un messaggio vocale preregistrato che pronuncia il nome della pagina, aumentando sensibilmente il carico cognitivo richiesto per completare il task"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Un percorso a ostacoli per atleti professionisti; tale impostazione trascura la complessità dei modelli mental degli utenti e l'impatto del carico cognitivo sul tasso di successo",
          "Un labirinto mitologico progettato da Dedalo per nascondere il Minotauro, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          ...
          "Un puzzle di mille tessere da ricomporre con pazienza, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo"
        ],
        "correctIndex": 2,
    ...
    "examQuiz": [
      {
        ...
        "options": [
          "Un comportamento illecito secondo le direttive commerciali europee, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          "Un gravissimo errore che viola le leggi internazionali sull'usabilità; questa scelta progettuale contraddice i risultati dei test empirici e introduce barriere ingiustificate nell'esperienza d'uso",
          "Una scelta sbagliata poiché l'utente deve poter accedere alla homepage in qualsiasi secondo; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
      ...
      },
      {
        ...
        "options": [
          ...
          "Posizionarle sopra il titolo dell'articolo in caratteri piccoli, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
          "Utilizzare il simbolo '>' come separatore tra i livelli gerarchici, una semplificazione che disattende le euristiche fondamentali di usabilità",
          "Rendere cliccabili tutti i livelli tranne l'ultimo (la pagina attuale), generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Perché i monitor desktop non possono renderizzare più di sette parole affiancate, secondo i protocolli consolidati di user testing",
          ...
          "Perché i browser mobili nascondono automaticamente le voci successive alla settima, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
          "Perché il consorzio W3C impone sanzioni economiche ai siti con menu troppo ampi, riducendo l'usabilità complessiva del sistema"
        ],
        "correctIndex": 1,
    ...
    "quiz": [
      {
        ...
        "options": [
          "Un algoritmo per comprimere le immagini all'interno di archivi ZIP, un approccio che ignora la centralità dell'utente reale e le dinamiche di navigazione rapida basate sull'euristica del satisficing",
          "Un test di resistenza fisica per i computer portatili trasportati in automobile; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Una procedura per verificare la velocità di caricamento delle pagine web su rete 4G, un errore comune che antepone le preferenze soggettive del team di sviluppo ai reali bisogni emersi dall'osservazione sul campo",
      ...
      },
      {
        ...
        "options": [
          ...
          "Quanto costa il dominio? Chi è il programmatore? In che linguaggio è scritto? Che versione di database usa? Quanto consuma il server? Chi è il grafico?, rallenta la ricerca",
          "Che ore sono? Che tempo fa? Qual è il valore dell'indice azionario? Quanti utenti sono connessi? Qual è la velocità del Wi-Fi? Dove si trova il server?, crea attrito d'uso",
          "Solo due domande: Qual è il nome dell'amministratore delegato e dove si trova la sede legale dell'impresa?, aumentando sensibilmente il carico cognitivo richiesto per completare il task"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Un'immagine decorativa priva di testo alternativo, riducendo la tolleranza all'errore e moltiplicando i passaggi operativi superflui",
          ...
          "La data e l'ora visualizzate nell'angolo dello schermo, una semplificazione che disattende le euristiche fondamentali di usabilità",
          "Il nome del file sorgente visualizzato nella barra di stato del browser, ignorando la tendenza naturale degli utenti a scansionare anziché leggere"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "L'utilizzo di uno sfondo bianco uniforme, una pratica che riduce l'usabilità complessiva, ostacolando l'orientamento spaziale e la percezione dei percorsi di navigazione primari",
          "La presenza di troppe fotografie ad alta risoluzione, ignorando che gli utenti non leggono le pagine parola per parola ma cercano indizi visivi immediati per proseguire il loro compito",
          ...
          "La presenza di link che rimandano ad altre pagine dello stesso sito, un approccio che ignora la centralità dell'utente reale e le dinamiche di navigazione rapida basate sull'euristica del satisficing"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Si confronta il codice HTML con le direttive del manuale del linguaggio C++, ignorando che gli utenti non leggono le pagine parola per parola ma cercano indizi visivi immediati per proseguire il loro compito",
          "Si esegue uno script automatico da terminale Linux per testare il throughput dei socket TCP, la cui misurazione richiede strumenti diagnostici dedicati e banchi di prova hardware",
          "Si misura la temperatura della batteria del dispositivo mobile durante la navigazione; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
    ...
    "examQuiz": [
      {
        ...
        "options": [
          ...
          "Un errore di routing del certificato SSL del server, ignorando la tendenza naturale degli utenti a scansionare anziché leggere",
          "La mancata installazione del font tipografico nel sistema operativo del client, disattendendo le consolidate euristiche di usabilità",
          "Una violazione delle specifiche CSS Grid di livello 2, senza validare l'ipotesi attraverso test qualitativi o sessioni di Thinking Aloud"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Per consentire ai browser di calcolare correttamente la larghezza della pagina, ignorando la tendenza naturale degli utenti a scansionare anziché leggere",
          ...
          "Perché i fogli di stile CSS non supportano testi diversi tra link e titoli, riducendo la tolleranza all'errore e moltiplicando i passaggi operativi superflui",
          "Perché altrimenti il server restituisce un codice di errore HTTP 301, secondo i protocolli consolidati di user testing"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Viene impiegata per registrare nuovi account sul database, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          "Serve unicamente per cercare termini all'interno del dizionario della lingua italiana, una semplificazione che disattende le euristiche fondamentali di usabilità",
          ...
          "Permette di inviare segnalazioni di bug al team di sviluppo software, compromettendo il cosiddetto 'odore dell'informazione' necessario alla navigazione"
        ],
        "correctIndex": 2,
    ...
    "quiz": [
      {
        ...
        "options": [
          ...
          "I programmatori e i contadini condividono gli stessi orari di lavoro all'alba; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "L'industria alimentare è stata la prima ad adottare il Responsive Web Design, compromettendo il cosiddetto 'odore dell'informazione' necessario alla navigazione",
          "I siti web di agricoltura richiedono palette cromatiche basate su toni di marrone e verde; questa scelta progettuale contraddice i risultati dei test empirici e introduce barriere ingiustificate nell'esperienza d'uso"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Perché la media matematica richiede calcoli statistici che i designer non sanno fare, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          ...
          "Perché tutti gli utenti web hanno esattamente le medesime abitudini di navigazione nelle memorie tampone e nei registri interni",
          "Perché i sistemi operativi moderni non consentono la profilazione degli utenti, disattendendo le consolidate euristiche di usabilità"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Fare una votazione democratica a maggioranza tra i membri del team, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          "Chiedere al dirigente più alto in grado (HiPPO) di decidere secondo il proprio gusto personale, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
          ...
          "Lanciare una moneta per scegliere tra le opzioni concorrenti, una semplificazione che disattende le euristiche fondamentali di usabilità"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Elimina automaticamente tutti i problemi di compatibilità mobile; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Garantisce che il sito web vincerà sicuramente premi internazionali di grafica, un errore comune che antepone le preferenze soggettive del team di sviluppo ai reali bisogni emersi dall'osservazione sul campo",
          "Aumenta la velocità di caricamento del codice sul server, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
      ...
      },
      {
        ...
        "options": [
          ...
          "Perché gli utenti mentono deliberatamente per compiacere i ricercatori; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Perché i sondaggi online sono vietati dalle normative sulla privacy europea, un approccio che ignora la centralità dell'utente reale e le dinamiche di navigazione rapida basate sull'euristica del satisficing",
          "Perché nessuno compila mai questionari composti da più di una domanda, senza validare l'ipotesi attraverso test qualitativi o sessioni di Thinking Aloud"
        ],
        "correctIndex": 0,
    ...
    "examQuiz": [
      {
        ...
        "options": [
          "L'effetto Dunning-Kruger sulla complessità del codice CSS, secondo i principi predittivi della legge di Hick",
          "La falsa equivalenza tra il proprio gusto personale e le necessità dell'intero pubblico di utilizzatori",
          "La sindrome dell'impostore applicata alla progettazione grafica, alterando i punti di contatto del percorso utente",
          "L'illusione di controllo sui server di produzione, una scelta progettuale che viola le convenzioni d'uso consolidate nel web"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Un protocollo per la crittografia delle transazioni bancarie; tale impostazione trascura la complessità dei modelli mental degli utenti e l'impatto del carico cognitivo sul tasso di successo",
          "Un algoritmo per l'ottimizzazione della compressione delle immagini JPEG; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          ...
          "Un framework di programmazione per dispositivi mobili iOS, senza validare l'ipotesi attraverso test qualitativi o sessioni di Thinking Aloud"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Minacciare di abbandonare il progetto se non viene approvato il layout proposto, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          "Rifiutarsi di modificare qualsiasi pixel sostenendo la sacralità dell'ispirazione; tale impostazione trascura la complessità dei modelli mental degli utenti e l'impatto del carico cognitivo sul tasso di successo",
          "Accettare passivamente qualsiasi richiesta del committente senza fornire argomentazioni tecniche, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
    ...
    "quiz": [
      {
        ...
        "options": [
          "Coinvolgere almeno cinquecento persone in un laboratorio scientifico a specchio unidirezionale con telecamere professionali, ostacolando il flusso naturale d'interazione",
          ...
          "Affidare l'intero processo a una società di consulenza esterna con budget milionario, una semplificazione che disattende le euristiche fondamentali di usabilità",
          "Eseguire i test unicamente la settimana successiva al lancio definitivo del sito web, una scelta progettuale che viola le convenzioni d'uso consolidate nel web"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Perché le leggi sulla privacy vietano di intervistare più di cinque persone al giorno; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Perché i laboratori di usabilità non dispongono di più di tre sedie fisiche, ignorando che gli utenti non leggono le pagine parola per parola ma cercano indizi visivi immediati per proseguire il loro compito",
          ...
          "Perché i computer non possono registrare più di tre sessioni video contemporaneamente; tale impostazione trascura la complessità dei modelli mental degli utenti e l'impatto del carico cognitivo sul tasso di successo"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Far recitare all'utente una serie di comandi vocali per attivare l'assistente virtuale per facilitare il rapido completamento del task",
          "Obbligare l'utente a leggere a voce alta tutti i testi della pagina web per valutarne la dizione, una semplificazione che disattende le euristiche fondamentali di usabilità",
          "Registrare i rumori di sottofondo dell'ambiente domestico del tester, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
      ...
      },
      {
        ...
        "options": [
          ...
          "Autoritario e severo: deve correggere immediatamente l'utente ogni volta che commette un errore di clic, secondo i principi predittivi della legge di Hick",
          "Promozionale: deve illustrare i pregi commerciali del prodotto e convincere il partecipante ad acquistarlo, disattendendo le consolidate euristiche di usabilità",
          "Passivo: deve abbandonare la stanza lasciando l'utente completamente solo, una semplificazione che disattende le euristiche fondamentali di usabilità"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Scrivere una relazione accademica di duecento pagine e attendere l'approvazione del consiglio di amministrazione, disattendendo le consolidate euristiche di usabilità",
          ...
          "Cancellare l'intero progetto e ricominciare da zero con un nuovo framework, compromettendo il cosiddetto 'odore dell'informazione' necessario alla navigazione",
          "Inviare una diffida legale agli utenti che hanno criticato l'interfaccia, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo"
        ],
        "correctIndex": 1,
    ...
    "examQuiz": [
      {
        ...
        "options": [
          "Interrompere il test ed espellere il partecipante per manifesta incapacità tecnica, senza validare l'ipotesi attraverso test qualitativi o sessioni di Thinking Aloud",
          "Confermare l'affermazione per non interrompere il flusso spontaneo dei pensieri, una semplificazione che disattende le euristiche fondamentali di usabilità",
          ...
          "Spiegargli passo dopo passo come funziona il sistema operativo del computer, ignorando la tendenza naturale degli utenti a scansionare anziché leggere"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Il Focus Group è qualitativo mentre il Test di Usabilità è solo quantitativo, un approccio che ignora la centralità dell'utente reale e le sue effettive modalità di interazione con il sistema nel contesto quotidiano e operativo di utilizzo",
          "Il Focus Group si fa online e il Test di Usabilità si fa solo su carta, una prospettiva che esclude dalla valutazione i fattori emotivi, motivazionali e situazionali che modellano concretamente il comportamento dell'utente durante l'uso del sistema",
          "Non sussiste alcuna differenza reale di metodologia; questa visione riduttiva non considera l'impatto cumulativo dei microdettagli d'interazione sulla soddisfazione complessiva, sulla fiducia percepita e sulla capacità di completamento dei task",
      ...
      },
      {
        ...
        "options": [
          ...
          "Perché i browser non consentono di modificare più di dieci righe di codice a settimana; tale impostazione trascura la complessità dei modelli mental degli utenti e l'impatto del carico cognitivo sul tasso di successo",
          "Perché i programmatori rifiutano di lavorare su sezioni già completate; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Perché le normative europee vietano i cambiamenti strutturali dopo la fase beta, ignorando che gli utenti non leggono le pagine parola per parola ma cercano indizi visivi immediati per proseguire il loro compito"
        ],
        "correctIndex": 0,
    ...
    "quiz": [
      {
        ...
        "options": [
          "L'obbligo di utilizzare caratteri tipografici in bianco e nero, un errore comune che antepone le preferenze soggettive del team di sviluppo ai reali bisogni emersi dall'osservazione sul campo",
          "L'assenza di connessione internet ad alta velocità; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          ...
          "L'impossibilità di elaborare immagini vettoriali SVG, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Perché i sistemi operativi mobili non supportano i menu a scorrimento laterale, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
          "Perché l'icona dell'hamburger richiede troppa memoria RAM per essere disegnata, ignorando il comportamento tipico di satisficing",
          "Perché gli utenti vegetariani rifiutano di toccare icone con riferimenti alla carne, riducendo la tolleranza all'errore e moltiplicando i passaggi operativi superflui",
      ...
      },
      {
        ...
        "options": [
          ...
          "L'aumento vertiginoso del consumo della batteria dello smartphone; tale soluzione viola il principio di visibilità dello stato del sistema, lasciando l'utente incerto sull'esito della propria azione",
          "L'obbligo di utilizzare solo schermi con risoluzione 4K; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "La scomparsa definitiva delle fotografie a colori dalle pagine web; questa scelta progettuale contraddice i risultati dei test empirici e introduce barriere ingiustificate nell'esperienza d'uso"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Lo spazio occupato dall'impronta digitale sul lettore biometrico, un approccio che ignora la centralità dell'utente reale e le dinamiche di navigazione rapida basate sull'euristica del satisficing",
          ...
          "Una sezione del menu riservata ai giochi per ragazzi; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Il margine di sicurezza applicato ai lati dei testi tipografici, compromettendo il cosiddetto 'odore dell'informazione' necessario alla navigazione"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Almeno 200x200 pixel per qualsiasi link nel modello mentale condiviso dell'utente finale",
          "Esattamente 10x10 pixel, alterando i punti di contatto del percorso utente",
          "Almeno 44x44 (o 48x48) pixel/punti CSS, con adeguato spazio di rispetto attorno all'elemento",
          "Un millimetro quadrato indipendentemente dalla risoluzione, riducendo l'usabilità complessiva del sistema"
        ],
        "correctIndex": 2,
    ...
    "examQuiz": [
      {
        ...
        "options": [
          "La compatibilità retroattiva con i dispositivi dotati di penna stilo, crea attrito d'uso",
          "La legge di conservazione della massa applicata ai dispositivi digitali, viola le euristiche",
          "La normativa sulla crittografia dei dati personali, disattendendo le consolidate euristiche di usabilità",
      ...
      },
      {
        ...
        "options": [
          ...
          "Perché i telefoni cellulari non supportano i fogli di stile CSS3 per facilitare il rapido completamento del task",
          "Perché i touch screen riconoscono solo il passaggio di oggetti metallici, ignorando la tendenza naturale degli utenti a scansionare anziché leggere",
          "Perché il browser mobile disabilita automaticamente tutte le animazioni di transizione, disattendendo le consolidate euristiche di usabilità"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Occupa l'intero schermo impedendo la visualizzazione dei contenuti, ignorando che gli utenti non leggono le pagine parola per parola ma cercano indizi visivi immediati per proseguire il loro compito",
          ...
          "Permette di riprodurre video musicali in streaming continuo; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Sostituisce completamente la necessità di disporre di una homepage, un approccio che ignora la centralità dell'utente reale e le dinamiche di navigazione rapida basate sull'euristica del satisficing"
        ],
        "correctIndex": 1,
    ...
    "quiz": [
      {
        ...
        "options": [
          "Una tecnologia destinata a essere sostituita dai visori di realtà virtuale, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          "Un insieme di regole superflue che distruggono l'estetica moderna del sito; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Un requisito riservato unicamente ai siti delle pubbliche amministrazioni statali; tale impostazione impedisce all'utente di costruire un modello mentale coerente",
      ...
      },
      {
        ...
        "options": [
          ...
          "Facendosi leggere lo schermo da un operatore telefonico umano in tempo reale, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          "Utilizzando monitor a raggi ultravioletti ad altissimo contrasto, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
          "Memorizzando il codice sorgente HTML prima dell'apertura del browser; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Mostrare una scritta pubblicitaria a pagamento sopra la fotografia, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          ...
          "Aumentare la velocità di scaricamento del file grafico dal server; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Modificare la palette dei colori dell'immagine in tempo reale, alterando i punti di contatto del percorso utente"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "È obbligatorio scrivere 'Questa è una decorazione senza importanza', generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          "Bisogna rimuovere completamente il tag img dal codice HTML, un errore comune che antepone le preferenze soggettive del team di sviluppo ai reali bisogni emersi dall'osservazione sul campo",
          ...
          "Si deve collegare l'immagine a una pagina di spiegazione esterna; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Perché riduce le dimensioni dei file memorizzati nel database; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Perché obbliga il browser a utilizzare caratteri tipografici con grazie, ignorando che gli utenti non leggono le pagine parola per parola ma cercano indizi visivi immediati per proseguire il loro compito",
          "Perché impedisce ai bot automatici di scaricare i testi del sito; tale impostazione trascura la complessità dei modelli mental degli utenti e l'impatto del carico cognitivo sul tasso di successo",
    ...
    "examQuiz": [
      {
        ...
        "options": [
          ...
          "I visitatori che utilizzano monitor widescreen da ufficio; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Gli utenti registrati con indirizzo email aziendale, un errore comune che antepone le preferenze soggettive del team di sviluppo ai reali bisogni emersi dall'osservazione sul campo",
          "I programmatori che lavorano su sistemi operativi Linux, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Il principio di sovranità digitale del consumatore, ignorando che gli utenti non leggono le pagine parola per parola ma cercano indizi visivi immediati per proseguire il loro compito",
          ...
          "La conformità con il protocollo di streaming video WebRTC; tale impostazione trascura la complessità dei modelli mental degli utenti e l'impatto del carico cognitivo sul tasso di successo",
          "L'interoperabilità dei metadati Dublin Core, una pratica che riduce l'usabilità complessiva, ostacolando l'orientamento spaziale e la percezione dei percorsi di navigazione primari"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Consente di disattivare l'uso dei certificati di sicurezza SSL; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Aumenta la frequenza di aggiornamento della scheda grafica; una grandezza elettrica che varia in base al carico computazionale e alla temperatura operativa",
          ...
          "Elimina automaticamente tutti gli errori nel codice JavaScript, riducendo la tolleranza all'errore e moltiplicando i passaggi operativi superflui"
        ],
        "correctIndex": 2,
    ...
    "quiz": [
      {
        ...
        "options": [
          ...
          "Il saldo economico residuo sulla carta prepagata dell'utente, disattendendo le consolidate euristiche di usabilità",
          "La capacità massima di archiviazione dei cookie nel browser, ignorando il comportamento tipico di satisficing",
          "Il volume di dati scaricabili prima del rallentamento della connessione, compromettendo la prevedibilità dell'architettura"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "Fornire risposte chiare alle domande frequenti e rendere evidenti i prezzi, una pratica che riduce l'usabilità complessiva, ostacolando l'orientamento spaziale e la percezione dei percorsi di navigazione primari",
          ...
          "Consentire all'utente di stampare la pagina in un formato pulito e leggibile; tale soluzione viola il principio di visibilità dello stato del sistema, lasciando l'utente incerto sull'esito della propria azione",
          "Mostrare breadcrumbs ordinate e titoli di pagina espliciti, un approccio che ignora la centralità dell'utente reale e le sue effettive modalità di interazione con il sistema nel contesto quotidiano e operativo di utilizzo"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Nascondere il menu di navigazione per forzare la scansione della homepage, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          "Obbligare l'utente a guardare un video promozionale di due minuti prima dell'acquisto; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          ...
          "Inviare tre email di notifica al minuto durante la compilazione del carrello; questa scelta progettuale contraddice i risultati dei test empirici e introduce barriere ingiustificate nell'esperienza d'uso"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Perché è determinato dalla velocità in megabit della connessione a internet, secondo le specifiche industriali pubblicate nei data sheet ufficiali dei produttori",
          "Perché viene calcolato automaticamente dalla scheda madre del computer, compromettendo il cosiddetto 'odore dell'informazione' necessario alla navigazione",
          "Perché dipende dal sistema operativo installato sullo smartphone, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
      ...
      },
      {
        ...
        "options": [
          ...
          "Il blocco automatico del processore del computer a livello di microcodice e firmware di sistema",
          "La disconnessione della linea telefonica domestica, compromettendo la prevedibilità dell'architettura",
          "La perdita di tutti i file salvati nella cartella documenti, aumentando sensibilmente il carico cognitivo richiesto per completare il task"
        ],
        "correctIndex": 0,
    ...
    "examQuiz": [
      {
        ...
        "options": [
          "Una procedura corretta per educare gli utenti alla disciplina informatica; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          ...
          "Un requisito obbligatorio imposto dai circuiti bancari internazionali, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          "Un comportamento irrilevante che non produce alcun impatto sulla soddisfazione, un approccio che ignora la centralità dell'utente reale e le dinamiche di navigazione rapida basate sull'euristica del satisficing"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Telefonano all'agenzia immobiliare per complimentarsi della scelta; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Compilano entusiasti la registrazione condividendo tutti i propri dati, senza validare l'ipotesi attraverso test qualitativi o sessioni di Thinking Aloud",
          ...
          "Installano un nuovo browser per verificare se l'ostacolo scompare, introducendo un attrito cognitivo ingiustificato"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Chiudendo l'applicazione senza mostrare alcun avviso; tale soluzione viola il principio di visibilità dello stato del sistema, lasciando l'utente incerto sull'esito della propria azione",
          "Con un codice alfanumerico crittografato come 'Error 0x004F8B' senza spiegazioni; questa scelta progettuale contraddice i risultati dei test empirici e introduce barriere ingiustificate nell'esperienza d'uso",
          "Accusando l'utente di aver violato le condizioni di licenza del software; tale impostazione trascura la complessità dei modelli mental degli utenti e l'impatto del carico cognitivo sul tasso di successo",
    ...
    "quiz": [
      {
        ...
        "options": [
          "Scrivere lettere anonime di protesta agli azionisti dell'impresa, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
          ...
          "Applicare le modifiche di nascosto durante la notte senza avvisare nessuno; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa",
          "Accettare passivamente qualsiasi richiesta anche se peggiora palesemente il servizio, una semplificazione che disattende le euristiche fondamentali di usabilità"
        ],
        "correctIndex": 1,
      ...
      },
      {
        ...
        "options": [
          "Attacchi informatici condotti da gruppi estremisti contro i server web, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          "Conflitti confessionali tra colleghi di religioni diverse, secondo i protocolli consolidati di user testing",
          ...
          "La concorrenza economica tra società che producono sistemi operativi, alterando i punti di contatto del percorso utente"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Perché il consorzio W3C vieta la pubblicazione di testi di aiuto, ignorando che gli utenti non leggono le pagine parola per parola ma cercano indizi visivi immediati per proseguire il loro compito",
          "Perché i motori di ricerca penalizzano i siti che aggiungono più di tre parole al mese, senza validare l'ipotesi attraverso test qualitativi o sessioni di Thinking Aloud",
          "Perché i database non possono memorizzare nuovi paragrafi, compromettendo il cosiddetto 'odore dell'informazione' necessario alla navigazione",
      ...
      },
      {
        ...
        "options": [
          ...
          "L'intransigenza assoluta e il rifiuto di parlare con gli ingegneri del software, secondo i protocolli consolidati di user testing",
          "L'uso esclusivo di termini tecnici in lingua inglese per intimidire i committenti, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          "La pretesa di prendere qualsiasi decisione finale senza consultare gli altri reparti, una semplificazione che disattende le euristiche fondamentali di usabilità"
        ],
        "correctIndex": 0,
      ...
      },
      {
        ...
        "options": [
          "La tecnologia del web è troppo complicata per essere compresa dalle persone comuni, una semplificazione che disattende le euristiche fondamentali di usabilità",
          ...
          "L'usabilità diventerà superflua con l'avvento dei microprocessori a controllo mentale, una scelta progettuale che viola le convenzioni d'uso consolidate nel web",
          "Solo chi possiede una laurea in ingegneria aerospaziale può progettare siti web, aumentando sensibilmente il carico cognitivo richiesto per completare il task"
        ],
        "correctIndex": 1,
    ...
    "examQuiz": [
      {
        ...
        "options": [
          "Sostenendo che il consorzio W3C ha vietato l'uso dei caroselli nei paesi europei, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
          "Scollegando il server di sviluppo dalla rete elettrica, riducendo la tolleranza all'errore e moltiplicando i passaggi operativi superflui",
          ...
          "Affermando che i caroselli possono essere visti solo con monitor a tubo catodico; questa soluzione crea disorientamento spaziale all'interno dell'architettura informativa"
        ],
        "correctIndex": 2,
      ...
      },
      {
        ...
        "options": [
          "Che lo sviluppo del prodotto è definitivamente concluso, riducendo la tolleranza all'errore e moltiplicando i passaggi operativi superflui",
          "Che il test era truccato e va rifatto da capo con utenti diversi, senza validare l'ipotesi attraverso test qualitativi o sessioni di Thinking Aloud",
          "Che il compito era troppo banale e va reso più complicato per metterli alla prova, generando frizione nell'interazione e frustrazione nel raggiungimento dell'obiettivo",
      ...
      },
      {
        ...
        "options": [
          ...
          "Se il file CSS supera le diecimila righe di codice sorgente, ignorando la tendenza naturale degli utenti a scansionare anziché leggere",
          "Se il sito web vince un trofeo in un concorso di grafica pubblicitaria, aumentando sensibilmente il carico cognitivo richiesto per completare il task",
          "Se il costo complessivo di sviluppo ha superato il budget iniziale del cliente, una scelta progettuale che viola le convenzioni d'uso consolidate nel web"
        ],
        "correctIndex": 0,
